...
export function FileTypeIcon({ mimeType }: { mimeType: string | null }) {
  ...
  const configs: Record<string, { bg: string; text: string; label: string }> = {
    ...
    "zip": { bg: "bg-violet-600/10", text: "text-violet-400", label: "ZIP" },
    "compressed": { bg: "bg-violet-600/10", text: "text-violet-400", label: "ZIP" },
    ...
    "presentation": { bg: "bg-violet-600/10", text: "text-violet-400", label: "PPT" },
    "slide": { bg: "bg-violet-600/10", text: "text-violet-400", label: "PPT" },
